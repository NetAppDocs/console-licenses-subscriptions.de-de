...
summary: Sehen Sie sich die Vertragsdetails für jeden Ihrer On-Premises ONTAP Cluster an. 
---
...
[role="lead"]
In der NetApp Console können Sie einen ONTAP Cluster entdecken und Vertragsdetails für jeden lokal gefundenen ONTAP Cluster anzeigen.
