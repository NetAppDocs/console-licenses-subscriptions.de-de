...
.AWS
--
Das folgende Video zeigt die Schritte zum Abonnieren der NetApp Console über den AWS Marketplace:

.Abonnieren Sie die NetApp Console vom AWS Marketplace
video::096e1740-d115-44cf-8c27-b051011611eb[panopto]
--
.Azurblau
--
Das folgende Video zeigt die Schritte zum Abonnieren der NetApp Console über den Azure Marketplace:

.Abonnieren Sie die NetApp Console vom Azure Marketplace
...
.Schritte
. Wählen Sie im Menü der NetApp Console *Governance > Licenses and subscriptions*.
. Wählen Sie *Marketplace-Abonnements* aus.
