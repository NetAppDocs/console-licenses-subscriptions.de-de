...
* * Keystone Abonnements* werden im Rahmen Ihres Keystone Vertrags verwaltet, wobei Rechnungsempfänger und Kostenstellenkennzeichnungen über dieselbe Schnittstelle gehandhabt werden.
...
* *Dialog zur Bestätigung der Änderungen* — Wird vor der Anwendung der Abrechnungsaktualisierungen angezeigt und ermöglicht Administratoren, die Änderungen zu überprüfen und zu bestätigen.  Diese Sicherheitsvorkehrung hilft, versehentliche Konfigurationsänderungen zu verhindern, die dazu führen könnten, dass Gebühren dem falschen Konto zugeordnet werden.
