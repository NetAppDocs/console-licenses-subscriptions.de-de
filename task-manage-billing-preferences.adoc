...
WARNING: Sobald diese Funktion aktiviert ist, können benutzerdefinierte CVO-Konfigurationen nicht mehr über die **Abrechnungseinstellungen** rückgängig gemacht werden. Durch Deaktivieren dieser Option wird die gesamte CVO-Abrechnung auf die Standard-Abrechnungskonfiguration für Ihre Datendienste zurückgesetzt.
