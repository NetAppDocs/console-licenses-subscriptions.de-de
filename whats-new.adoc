...
Einzelheiten zu den Änderungen finden Sie unter link:https://docs.netapp.com/us-en/console-relnotes/index.html["Versionshinweise zur NetApp Console"].
...
https://docs.netapp.com/us-en/console-setup-admin/task-monitor-cm-operations.html["Erfahren Sie, wie Sie E-Mail-Benachrichtigungen einrichten"^]
...
Digital Wallet zeigt Ihnen jetzt die insgesamt in Ihrem Konto verbrauchte Kapazität sowie die durch das Lizenzpaket verbrauchte Kapazität an. Dies kann Ihnen helfen zu verstehen, wie Ihnen Kosten berechnet werden und ob Sie zusätzliche Kapazität erwerben müssen.
