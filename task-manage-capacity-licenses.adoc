...
---
= Kapazitätsbasierte Lizenzierung für Cloud Volumes ONTAP verwalten
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
Um die für das Essentials Paket angezeigten Kapazitäten besser zu verstehen, ist es hilfreich, mit dem Ladevorgang vertraut zu sein https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-licensing.html#notes-about-charging["Informieren Sie sich über die Gebühren für das Essentials-Paket"^].
...
* Wenn die Cloud Volumes ONTAP Kapazität über das eigenständige Cloud Volumes ONTAP Abonnement im AWS Marketplace abgerechnet werden soll, muss das Cloud Volumes ONTAP System ein unterstütztes kapazitätsbasiertes Paket (Essentials oder Freemium) verwenden. Das Professional Paket wird für die eigenständige Auflistung nicht unterstützt und weiterhin über das NIS Abonnement abgerechnet. Nach Auswahl des gewünschten Pakets kann in den *Abrechnungseinstellungen* der NetApp Console das Marketplace Abonnement ausgewählt werden, das für die Abrechnung von Cloud Volumes ONTAP verwendet wird.
...
| Gesamte vorab festgelegte Kapazität | Die gesamte von Ihnen bei NetApp erworbene Lizenzkapazität, einschließlich sowohl BYOL-Lizenzen als auch Marketplace-Verträgen. Dieser Wert ist die Summe der gesamten BYOL-Kapazität und der gesamten Kapazität der Marketplace-Verträge. 
