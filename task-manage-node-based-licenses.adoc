...
summary: Die knotenbasierten Lizenzen werden in der NetApp Console verwaltet, sodass jedes Cloud Volumes ONTAP System über eine gültige Lizenz mit der erforderlichen Kapazität verfügt. 
---
= Knotenbasierte Lizenzierung für Cloud Volumes ONTAP verwalten
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
