...
[role="lead"]
Das *Übersichts*-Dashboard in der NetApp Console hilft Ihnen, den Status Ihrer Lizenzen und Abonnements zu überwachen, um sicherzustellen, dass Sie die Kosten kontrollieren und den Service aufrechterhalten können, wenn Abonnements ein Ablaufdatum oder Kapazitätsgrenzen erreichen.
...
+
Neue Lizenzen oder Abonnements können Sie nicht über die *Übersicht*-Seite für einen bestimmten Service hinzufügen. Sie können Lizenzen nur über den Tab *Direct licenses* oder Abonnements über den Tab *Marketplace subscriptions* hinzufügen.
...
+
** link:task-manage-data-services-licenses.html["Erfahren Sie mehr über die Verwaltung von Lizenzen"].
** link:task-manage-subscriptions.html["Weitere Informationen zum Verwalten von Abonnements"].
